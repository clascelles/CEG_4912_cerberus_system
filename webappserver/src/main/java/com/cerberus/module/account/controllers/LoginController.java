...
public class LoginController extends CerberusController {
	...
	public String getLoginPage(Model model) {
		...
		model.addAttribute(AccountConstants.LOGIN_BACKING_OBJECT, new LoginBackingObject());
		model.addAttribute(AccountConstants.NEW_ACCOUNT_BACKING_OBJECT, new NewAccountBackingObject());
	...
	public String validateLogin(Model model,
			...
			@ModelAttribute (AccountConstants.LOGIN_BACKING_OBJECT) LoginBackingObject loginBackingObject,
