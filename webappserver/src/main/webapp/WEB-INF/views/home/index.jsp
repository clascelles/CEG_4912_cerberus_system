...
<head>
	...
	<!-- The fav icon -->
	<link rel="shortcut icon" href="/webappserver/resources/img/favicon.ico">
					...
					<div class="box-content">
						...
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active" id="info">
								...
								<p>Its a fully featured, responsive template for your admin panel. Its optimized for tablet and mobile phones. Scan the QR code below to view it in your mobile device.</p> <img alt="QR Code" class="charisma_qr center" src="/webappserver/resources/img/qrcode136.png" />
							</div>
